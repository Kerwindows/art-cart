...
export const Signup = () => {
  ...
  const signupHandler = async () => {
    ...
    try {
      ...
      console.log('try signupCredential',signupCredential)
      setError("");
      if (signupCredential.password === signupCredential.confirmPassword) {
        ...
        if (response.status === 201) {
          ...
          toast.success(`You've successfully signed up, ${response.data.createdUser.firstName}`);
      ...
      setSignUpLoading(false);
      console.log('finally','blah blah blah finally')
    }
  };
